...
- Managed OS installation and troubleshooting for Windows 10/11 and Linux systems for 100+ users.
- Resolved L1/L2 technical queries regarding system performance and network connectivity (VPN/LAN).
- Administered user access and permissions via Active Directory.

---

### 🎓 Education
- **Bachelor's Degree** — Magadh University (Graduated 2017)
